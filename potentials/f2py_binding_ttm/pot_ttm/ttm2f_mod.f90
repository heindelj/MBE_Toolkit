...
!   ...........   gammaM
   ...
   subroutine ttm2f(Nw,RR,dRR,En) bind(C,name="ttm2f") 
...
!   use ttm2f_mod
   ...
   real(c_double), intent(in),  dimension(3, 3*Nw) :: RR
   real(c_double), intent(out), dimension(3, 3*Nw) :: dRR
   real(c_double), intent(out) :: En
   !
